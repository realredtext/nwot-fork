...
function updateUnread() {
	...
	if(totalCount) {
		total.style.display = "";
		total.innerText = totalCount > 999 ? "999+" : "(" + totalCount + ")";
	}
	if(chatPageUnread) {
		page.style.display = "";
		page.innerText = chatPageUnread > 999 ? "999+" : "(" + chatPageUnread + ")";
	}
	if(chatGlobalUnread) {
		global.style.display = "";
		global.innerText = chatGlobalUnread > 999 ? "999+" : "(" + chatGlobalUnread + ")";
	}
}
